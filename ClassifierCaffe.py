# -*- coding: utf-8 -*-
# https://github.com/facebook/C3D/blob/master/C3D-v1.0/python/caffe/classifier.py

import numpy as np
import caffe

class ClassifierCaffe_X(caffe.Net):
    """
         Classifier extends Net for image class prediction
         by scaling, center cropping, or oversampling.
    """

    def __init__(self, model_file, prototxt_file, image_dims=None,
        ...
        """
        caffe.Net.__init__(self, model_file, prototxt_file)
        self.set_phase_test()
